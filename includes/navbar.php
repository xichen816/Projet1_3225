    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-link <?= ($currentPage == 'index.php') ? 'active text-white' : '' ?>"
                    href="index.php">Explore</a>
                <a class="nav-link <?= ($currentPage == 'feed.php') ? 'active text-white' : '' ?>"
                    href="feed.php">Feed</a>
                <a class="nav-link <?= ($currentPage == 'profile.php') ? 'active text-white' : '' ?>"
